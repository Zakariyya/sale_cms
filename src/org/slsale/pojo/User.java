...
public class User extends Base{
	...
	public String toString() {
		return "User [loginCode=" + loginCode + ", password=" + password
				...
				+ ", sex=" + sex + ", birthday=" + birthday + ", cardType="
				+ cardType + ", cardTypeName=" + cardTypeName + ", idCard="
				+ idCard + ", country=" + country + ", mobile=" + mobile
				+ ", email=" + email + ", userAddress=" + userAddress
				+ ", postCode=" + postCode + ", createTime=" + createTime
				+ ", referId=" + referId + ", referCode=" + referCode
				+ ", roleId=" + roleId + ", roleName=" + roleName
				+ ", userType=" + userType + ", userTypeName=" + userTypeName
				+ ", isStart=" + isStart + ", lastUpdateTime=" + lastUpdateTime
				+ ", lastLoginTime=" + lastLoginTime + ", bankName=" + bankName
				+ ", accountHolder=" + accountHolder + ", bankAccount="
				+ bankAccount + ", idCardPicPath=" + idCardPicPath
